...
export default class Frak
{
     ...
     */
    constructor(throwErrorOnFailedStatus = false)
    {
     ...
     * @returns {Promise<Response>}
     */
    head(url, request, resolveJsonResponse = true)
    {
        return this._call(url, this._initializeRequest('HEAD', request), resolveJsonResponse);
    }
     ...
     * @returns {Promise<Response>}
     */
    connect(url, body, request, resolveJsonResponse = true)
    {
        return this._call(url, this._initializeRequest('CONNECT', request), resolveJsonResponse);
    }
     ...
     * @returns {Promise<Response>}
     */
    trace(url, request, resolveJsonResponse = true)
    {
        return this._call(url, this._initializeRequest('TRACE', request), resolveJsonResponse);
    }
