 ...
 *           The default is: {cache: 'default', mode: 'cors', headers: {}}
 *
...
class Frak
{
  ...
  constructor(settings, options)
  {
    ...
    {
      this._defaults = Object.assign(this._defaults, options);
    }
  }
  ...
  _initializeRequest(method, options)
  {
    ...
    return Object.assign(this._defaults, { headers: headers }, options, { method: method.toUpperCase() });
  }
